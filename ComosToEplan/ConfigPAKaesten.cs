...
namespace ComosToEplan
{
    ...
    public partial class MSRKaesten 
    {
        ...
        // public string Name; //neu
        // public List<MSRKaestenBMKPA[]> PABestueckung = new List<MSRKaestenBMKPA[]>(); // neu!! 
    ...
    public partial class MSRKaestenBMKPA
    {
        ...
        private byte anzahlSensoranschaltungField;
        ...
        /// <remarks/>
        public byte anzahlSensoranschaltung
        {
            get
            {
                return this.anzahlSensoranschaltungField;
            }
            set
            {
                this.anzahlSensoranschaltungField = value;
            }
        }
    }
}